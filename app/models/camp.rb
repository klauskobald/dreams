...
class Camp < ActiveRecord::Base
  ...
  def align_budget
    if self.minbudget_realcurrency.nil?
      ...
      self.minbudget = (self.minbudget_realcurrency / Rails.application.config.coin_rate)
    else
      self.minbudget = 0
    end
    ...
    if self.maxbudget_realcurrency.nil?
      ...
      self.maxbudget = (self.maxbudget_realcurrency / Rails.application.config.coin_rate)
    else
      self.maxbudget = 0
    end
  end
